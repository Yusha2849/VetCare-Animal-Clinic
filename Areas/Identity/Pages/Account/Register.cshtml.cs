...
namespace VetCare_Animal_Clinic.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var existingUser = await _userManager.FindByIdAsync(Input.IDNumber);
                ...
                if (result.Succeeded)
                {
                    ...
                    // Check the email domain and assign roles accordingly
